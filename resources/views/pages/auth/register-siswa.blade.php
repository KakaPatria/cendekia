                                ...
                                <div class="p-lg-5 p-4">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <form method="POST" action="{{ route('register.siswa') }}">
                                            ...
                                            <div class="mb-3"><label for="asal_sekolah" class="form-label">Asal Sekolah</label><input type="text" class="form-control" name="asal_sekolah" placeholder="Cario Asal Sekolah" value="{{ old('asal_sekolah') }}"></div>
                                                <div class="mb-3">
                                                    <label for="asal_sekolah" class="form-label">Asali Sekolah</label>
