                                                                        ...
                                                                        <div class="row mt-2">
                                                                            <div class="col-xxl-6">
                                                                                <div class="row border border-dashed gx-2 p-2">
                                                                                    ...
                                                                                    <!--end col-->
                                                                                    <div class="col-3">
                                                                                        <img src="{{ URL::asset('assets/images/small/img-7.jpg') }}" alt="" class="img-fluid rounded" />
                                                                                    </div>
                                                                                    <!--end col-->
                                                                                    <div class="col-3">
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="d-flex align-items-center gap-2">
                                                                    ...
                                                                    <div class="avatar-group">
                                                                        ...
                                                                        <div class="avatar-group-item">
                                                                            <div class="avatar-xs">
                                                                                <img src="{{ URL::asset('assets/images/users/avatar-5.jpg') }}" alt="" class="rounded-circle img-fluid" />
                                                                            </div>
                                                                        </div>
                                                                        <div class="avatar-group-item">
                                                                            <div class="avatar-xs">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="avatar-group">
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xs">
                                                                    <img src="{{ URL::asset('assets/images/users/avatar-1.jpg') }}" alt="" class="rounded-circle img-fluid" />
                                                                </div>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xs">
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <div class="avatar-group">
                                                            ...
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xs">
                                                                    <img src="{{ URL::asset('assets/images/users/avatar-7.jpg') }}" alt="" class="rounded-circle img-fluid" />
                                                                </div>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xs">
                                                                    <img src="{{ URL::asset('assets/images/users/avatar-6.jpg') }}" alt="" class="rounded-circle img-fluid" />
                                                                </div>
                                                            </div>
                                                            <div class="avatar-group-item">
                                                                <div class="avatar-xs">
