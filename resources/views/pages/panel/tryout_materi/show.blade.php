...
<div class="modal fade" id="edit-materi-modal" tabindex="-1" aria-labelledby="add-soal-label" aria-hidden="true">
    <div class="modal-dialog modal-lg ">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-invoice-label">Edit Mata Pelajaran</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <form action="{{route('panel.tryout.editMateri',$tryout_materi->tryout_materi_id)}}" id="edit-materi-form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="">
                            ...
                            <select class="form-control select-materi" id="edit-select-materi" name="materi_id" disabled>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="">
                            <select class="form-control " id="edit-select-pengajar" name="pengajar_id" disabled>
