...
@section('title', 'Verifikasi OTP Panel')
@section('css')
<style>
    /* Mengadopsi style dari halaman Lupa Password & Login (sama seperti siswa) */
    .auth-page-wrapper {
        min-height: 100vh;
        display: flex;
                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4 p-lg-5">
                            <div class="text-center mb-4">
                                ...
                                <h4 class="text-dark mt-4">Verifikasi Email Admin</h4>
                            ...
                            <div class="p-2">
                                <form action="{{ route('panel.verifyOtp') }}" method="POST">
                                    @csrf
