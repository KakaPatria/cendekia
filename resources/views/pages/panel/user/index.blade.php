            ...
            <div class="card-header ">
                ...
                <form action="">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-lg-2 col-sm-4">
                            <select class="form-select mb-2" id="filter-tipe_siswa" name="tipe_siswa">
                                <option value="">Pilih Tipe Siswa</option>
                                <option value="Cendekia" {{ request('tipe_siswa') == 'Cendekia' ? 'selected' : ''}}>Cendekia</option>
                                <option value="Umum" {{ request('tipe_siswa') == 'Umum' ? 'selected' : ''}}> Umum</option>
                            </select>
                        </div>
                        @endif
            ...
            <div class="modal-body">
                <form action="{{route('panel.user.store')}}" method="POST" id="create-form" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-9">
                            <select class="form-select mb-2" id="" name="tipe_siswa">
                                <option value="">Pilih Tipe Siswa</option>
